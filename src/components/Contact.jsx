...
const Contact = () => {
    ...
    const onSubmit = (data, e) => {
        ...
        emailjs.send(
            'service_9q4lnuc', // Replace with your EmailJS Service ID
            'template_6rtt5ba', // Replace with your EmailJS Template ID
            {
            ...
            'y9CgSGI9fVf5SdPAj' // Replace with your EmailJS Public Key
        )
            .then((response) => {
        ...
        <div className="bg-orange-600 h-1 w-16 rounded"></div>
            ...
            >
              <IoLocationOutline />
                        ...
                        {/* <div
  className="rounded-full h-fit bg-blue-100 p-2"
...
<div
  className="rounded-full h-fit bg-black p-2"
  style={{ color: "#60A5FA", fontSize: "28px" }} // Light blue (#60A5FA)
>
  <IoLocationOutline />
</div> */}
